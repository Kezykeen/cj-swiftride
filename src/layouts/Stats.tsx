...
const Stats: React.FC = () => {
  return (
    <div className="flex flex-col items-center gap-6 py-20 pb-50">
      {/* Icon */}
      <div className="h-15 w-15 flex items-center justify-center bg-blue-100 rounded-full">
      ...
      <p className="text-[#667085] text-[20px] text-center w-3xl">
      ...
      <div className="relative flex justify-between w-full max-w-[850px] mt-8">
        ...
        {stats.map((item) => (
          ...
          >
            ...
            <p className="text-gray-600 text-[18px] font-semibold">{item.label}</p>
          </div>
        ))}
      </div>
    </div>
