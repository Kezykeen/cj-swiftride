...
const TestimonialSubsection = () => {
  return (
    <div className="flex items-center mt-40 gap-20 ">
      {/* car section */}
      <section className="w-[671px]">
        <img src="/images/testimonial-car.png" alt="" />
      </section>
      ...
      <section className="flex flex-col w-[561px] gap-6">
        ...
        <p className="font-plus-jakarta text-[18px] text-[#6B6B6B] font-medium leading-[42px]">
          ...
          wallet, we set up your bidding account, place bids on your behalf, and
          keep you updated every step of the way — from payment confirmation to
          car delivery.
        </p>
